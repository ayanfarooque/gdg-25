...
class _LandingPageState extends State<FacResourceLanding>
  ...
  // Modified to load both news and resources with enhanced data
  ...
  // Update filtered items based on current selection, search query, and active filter
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      ...
      case 2:
        ...
        break;
      case 3:
        Navigator.pushReplacementNamed(context, '/teacherai');
        break;
      case 4:
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      FilterChip(
                                        ...
                                        selectedColor: teacherPrimaryColor,
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.book, size: 16, color: accentColor),
                    SizedBox(width: 4),
                    Text(
  ...
  // Show upload dialog for adding new resources
  void _showUploadDialog() {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("Upload New Content"),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              ListTile(
                leading: Icon(Icons.upload_file, color: accentColor),
                title: Text("Upload Resource"),
                subtitle: Text("Share educational materials"),
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text("Resource upload coming soon")),
                  );
                },
              ),
              ListTile(
                leading: Icon(Icons.post_add, color: teacherPrimaryColor),
                title: Text("Create News Post"),
                subtitle: Text("Share announcements or events"),
                onTap: () {
                  Navigator.pop(context);
                  ScaffoldMessenger.of(context).showSnackBar(
                    SnackBar(content: Text("News post creation coming soon")),
                  );
                },
              ),
            ],

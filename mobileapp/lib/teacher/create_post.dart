...
class _FacCreatePostPageState extends State<FacCreatePostPage> {
  ...
  final Color teacherPrimaryColor =
      const Color(0xFFE195AB); // Pink shade for teacher
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    SingleChildScrollView(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          const SizedBox(width: 8),
                                          _buildAttachmentButton('file',
                                              Icons.attach_file, 'Document'),
                                        ],
                                      ),
                                    ),
                                    ...
                                    SwitchListTile(
                                      title:
                                          const Text('Pin to top of community'),
                                      subtitle: const Text(
                                          'Post will appear at the top of the community feed'),
                                    ...
                                    SwitchListTile(
                                      title:
                                          const Text('Mark as featured post'),
                                      subtitle: const Text(
                                          'Highlight this post in the community'),
                                      value: _isFeatured,
                                      activeColor: teacherPrimaryColor,
                                      contentPadding: EdgeInsets.zero,
                                      onChanged: (bool value) {
                                    ...
                                    SwitchListTile(
                                      ...
                                      subtitle: const Text(
                                          'Alert students about this post'),
                              ...
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    _buildGuidelineItem(
                                        'Share educational insights and teaching strategies.'),
                                    _buildGuidelineItem(
                                        'Provide supportive feedback to fellow educators.'),
                                    _buildGuidelineItem(
                                        'Respect student privacy when discussing classroom experiences.'),
                                    _buildGuidelineItem(
                                        'Contribute to professional development discussions.'),
                                    _buildGuidelineItem(
  ...
  Widget _buildAttachmentButton(String type, IconData icon, String label) {
    ...
    return ElevatedButton.icon(
      ...
      style: ElevatedButton.styleFrom(
        backgroundColor:
            isSelected ? teacherPrimaryColor : Colors.grey.shade200,

...
const ViewAll = () => {
    ...
    useEffect(() => {
        const fetchAssignments = async () => {
            try {
                const response = await axios.get("http://localhost:5000/api/assignments/assignment");
    ...
    const handleSubmitAssignment = async (assignmentId) => {
        ...
        try {
            // will be changeing the below route will be doing in from subbmission controller and route 
    ...
    const handleCancelAssignment = async (assignmentId) => {
        ...
        try {
            //ye bhi submission controller se karna hai
            ...
            setAssignments((prevAssignments) =>
                prevAssignments.map((assignment) =>
                    assignment._id === assignmentId ? { ...assignment, status: "canceled" } : assignment
                )
            );

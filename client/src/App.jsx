...
import AITestSolver from './pages/AITestSolver';
...
const App = () => {
  ...
  return (
    <div className="flex h-screen w-full bg-[#ECE7CA] text-gray-100">
      ...
      {location.pathname !== '/' &&
        location.pathname !== '/authstudent' &&
        location.pathname !== '/authteacher' &&
        location.pathname !== '/authadmin' && <Sidebar role={role} />}
      ...
      <div className="flex-1 overflow-auto">
        <Routes>
          ...
          <Route path="/test-solver" element={<AITestSolver />} />
